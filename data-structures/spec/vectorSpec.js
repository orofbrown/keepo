describe('vector', function () {
  ...
  it('should implement constructing from existing vector', () => {
    array.forEach((i) => this.vector.add(i));
    const vec = new Vector(this.vector);
    expect(vec.elementCount).toBe(this.vector.elementCount);
    expect(vec.elementData).toEqual(this.vector.elementData);
    expect(vec.capacityIncrement).toEqual(this.vector.capacityIncrement);
    expect(vec._array.length).toBeGreaterThan(0);
  });
